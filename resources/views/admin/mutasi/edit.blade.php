        ...
        <form method="POST" action="{{ route('admin.mutasi.update', $mutasi) }}" class="space-y-4">
            ...
            <script>
                (function () {
                    ...
                    function isKeluar() {
                        return selectArah.value === 'keluar';
                    }
                    ...
                    function refreshDaftarBarang() {
                        ...
                        opsiBarang.forEach(function (opt) {
                            ...
                            var tersedia = !isKeluar() || (stok !== null && stok > 0);
                            opt.hidden   = !tersedia;
                    ...
                    function terapkanBatas() {
                        ...
                        if (isKeluar() && opt && opt.value && stok !== null) {
                    ...
                    selectArah.addEventListener('change', function () { refreshDaftarBarang(); clampJumlah(); });
