...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow w-full max-w-none overflow-hidden">
        ...
        <div class="p-5">
        <form method="POST" action="{{ route('admin.stok.store') }}" enctype="multipart/form-data" class="space-y-4"
              x-data="{ preview: null }">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="nama_barang" value="{{ old('nama_barang') }}" placeholder="Pilih Barang" required
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-200">
            ...
            <div>
                ...
                <input type="number" name="stok" min="0" value="{{ old('stok') }}" placeholder="Stok" required
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-200">
