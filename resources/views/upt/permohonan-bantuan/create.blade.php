...
<div class="bg-white rounded shadow overflow-hidden" x-data="permohonanForm()">
    <div class="bg-[#0f1f3d] text-white px-5 py-3 font-semibold">
        Tambah Data Permohonan Bantuan
    </div>

    <form method="POST" action="{{ route('upt.permohonan.store') }}" class="p-6">
        @csrf
        ...
        <div class="mb-6">
            ...
            <textarea name="alamat" rows="2" class="w-full border rounded px-3 py-2 text-sm">{{ old('alamat') }}</textarea>
        </div>
